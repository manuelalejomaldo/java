...
public class Decapotable extends Voiture
{
     ...
     */
    public static int VITESSE_MAX = 120;
    /**
    ...
    /**
     * Donnee membre indiquant la vitesse maximale du decapotable.
     */
    private int m_vitMax;
    ...
    {
        super(p_Nom, p_Plaque);

        this.setEtatToit(TOIT_FERME);
        this.m_vitMax = Decapotable.VITESSE_MAX;
    }
