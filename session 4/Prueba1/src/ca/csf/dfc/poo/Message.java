...
public abstract class Message<T> {
	 ...
	 */
	private final Personne m_persOrigine;
	/**
	 * /**
     *Membre personne destinataire de type personne 
	 */
	private final Personne m_persDestinataire;
	 /**
	 ...
	 * @param p_contenu
	 */
	public Message(Date p_dateenv, Personne p_persOrigine, Personne p_persDestinataire, Priorite p_priorite,
			T p_contenu) {
	 ...
	 */
	public Personne getPersOrigine() {
	 ...
	 */
	public Personne getPersDestinataire() {
