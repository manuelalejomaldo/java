...
public class DemoSwing extends JFrame
{
    ...
    public DemoSwing()
    {
        ...
        //agrega una animacion gif
        Icon ico_Jongleur = new ImageIcon(getClass().getResource("/img/dukejongleur.gif"));

        lbl_Jongleur.setIcon(ico_Jongleur);// agrega al JLabel el icnono
        ...
        txt_MotDePasse.setToolTipText("Entrez votre mot de passe");//texto cuando colocas la sourri desous

        // JButton avec images
        //captura imagen a variables
        ...
        btn_Demo.setIcon(ico_ImageRepos);//imagen par default
        btn_Demo.setRolloverIcon(ico_ImageSourisDessus);//cambia imagen cuando la sourris est desous
        btn_Demo.setToolTipText("Un beau bouton");//texto cuando la sourri est desous
