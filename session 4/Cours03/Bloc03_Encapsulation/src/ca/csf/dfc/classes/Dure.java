...
public class Dure {
		...
		*/
		 ...
		 */
		public Dure(int p_nbSecondes)
		{						
			this.setNbSecondes(p_nbSecondes % MINUTES_PAR_HEURE);			
			this.setNbMinutes((p_nbSecondes / MINUTES_PAR_HEURE) % MINUTES_PAR_HEURE);
			this.setNbSecondes(p_nbSecondes / (MINUTES_PAR_HEURE * MINUTES_PAR_HEURE));
		}
		 ...
		 */
		public Dure(int p_nbMinutes, int p_nbSecondes)
		{						
			this.setNbSecondes(p_nbSecondes);
			this.setNbMinutes(p_nbMinutes % MINUTES_PAR_HEURE);
			this.setNbHeures(p_nbMinutes / MINUTES_PAR_HEURE); 
		}
